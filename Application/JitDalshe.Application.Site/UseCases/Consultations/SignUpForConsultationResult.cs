using OneOf;
using static JitDalshe.Application.Site.UseCases.Consultations.SignUpForConsultationResult;

namespace JitDalshe.Application.Site.UseCases.Consultations;

[GenerateOneOf]
public sealed partial class SignUpForConsultationResult : OneOfBase<SignedUp, Error>
{

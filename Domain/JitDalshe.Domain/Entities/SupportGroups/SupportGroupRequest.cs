...
namespace JitDalshe.Domain.Entities.SupportGroups;

public sealed class SupportGroupRequest : AuditableEntity<IdOf<SupportGroupRequest>>
{
    ...
    private SupportGroupRequest(
        IdOf<SupportGroupRequest> id,
    ...
    public static SupportGroupRequest Create(
        IdOf<SupportGroupRequest> id,
        string applicantName,
        int applicantAge,
        string? applicantPhoneNumber,

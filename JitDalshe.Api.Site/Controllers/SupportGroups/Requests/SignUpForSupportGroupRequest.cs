...
namespace JitDalshe.Api.Site.Controllers.SupportGroups.Requests;

public readonly record struct SignUpForSupportGroupRequest(
...
public sealed partial class SignUpForSupportGroupRequestValidator : AbstractValidator<SignUpForSupportGroupRequest>
{
    ...
    public SignUpForSupportGroupRequestValidator()
    {
